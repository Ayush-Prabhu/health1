...
function QuestionForm() {
  ...
  function addOption(i) {
    ...
    if (quests[i].options.length < 5 && (quests[i].questionType==="MCQ"||quests[i].questionType==="MSQ")) {
    ...
    return (
                      ...
                      <div key={i}>
                        ...
                        >
                          ...
                          <div className="question_boxes">
                            {questions[i].weightSet !== 1 || !(questions[i].questionType ==="MCQ"||questions[i].questionType ==="MSQ")? (
                                    ...
                                    <FormControlLabel
                                      ...
                                      control={
                                        ques.questionType === "MCQ" ? (
                                          ...
                                          />
                                          <TextField onChange={(e)=>setregex(e.target.value,i)} placeholder={ques.regex?ques.regex:"enter regex"} ></TextField>
                                          </>
                                        )
                                      }
                                      label={ ques.questionType === "MCQ" || ques.questionType === "MSQ" ?(
                                        <div>
                                          <input
                                            type="text"
                                            className="textInput"
      ...
      />
                              <Button onClick={openLatexModal}>
                                <Icon
                                  fontSize="small" style={{textTransform:"none",color:"var(--text2)",paddingBottom:"30px",fontWeight:"bold"}}>Lₓ</Icon>
                              </Button>
